        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header">
                    <img src="{{ asset('white') }}/img/card-primary-2.png" alt="">
                    <h1 class="card-title">{{ __('BizScout') }}</h1>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <button type="submit" href="" class="btn btn-fill btn-success btn-lg btn-block mb-3">{{ __('Get Started') }}</button>
                    <div class="pull-left">
                        <h6>
